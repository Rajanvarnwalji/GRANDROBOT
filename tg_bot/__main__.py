...
TECHNO_IMG = https://telegra.ph/file/844ee3cfa31904cbc1b8f.jpg
IMPORTED = {}
MIGRATEABLE = []
HELPABLE = {}
STATS = []
        ...
        if len(args) >= 1:
            ...
            update.effective_message.reply_photo(
                ...
                parse_mode=ParseMode.MARKDOWN, reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton(text="🤝HELP🤝",
                                                                       ...
                                                                       url="t.me/Queen_Sara_Pro")],
                                                                                   [InlineKeyboardButton(text="ADD Queen BOT TO YOUR GROUP",
                                                                       url="t.me/{}?startgroup=true".format(bot.username)),
                                                                                   InlineKeyboardButton(text="Source Code",
                                                                       url="https://github.com/Hacker_boy_rajan_music_assistant/GRANDROBOT")
                                                                                 ]]))

    else:
        update.effective_message.reply_text("RUK JA BHAI BUSY HU 😡😡😡")
